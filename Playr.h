...
public:	Player() : hpText(std::to_string(hp), sf::Vector2f{ 0.f, 0.f })
	{
	...
	void Gameover() {
		...
		gameover.loadFromFile(IMAGES_FOLDER + GAMEOVER_FILE_NAME);
		sprite2.setTexture(gameover);
		sprite2.setPosition(GAMEOVER_START_POS);
